...
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.83.0 (90b35a623 2024-11-26) (built from a source tarball)";
#[doc=r#"The output of `rustdoc -V`; empty string if `rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub const RUSTDOC_VERSION: &str = r"rustdoc 1.83.0 (90b35a623 2024-11-26) (built from a source tarball)";
